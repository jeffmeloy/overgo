...
| 8 | Runtime admission | continuous batching, retained-cache, capture, and sequence-cache admission compiled; remaining architecture probes/fallbacks absent | Active |
