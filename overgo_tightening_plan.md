...
| 9 | Metadata validation | expert admission, sparse-indexer cadence, normalization defaults, and structural bounds are serialized profile facts; family predicates, probes, and validation-enum reconstruction absent | Active |
