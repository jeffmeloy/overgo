...
func assertProfessionalGUICampaignSnapshot(t *testing.T, document Plan) {
	...
	wantIDs := []string{
		...
		"empty-store-onboarding/do",
		"swap-proxy-cold-start/do",
		"cold-start-onboarding/do",
		"proxy-request-admission/do",
		"relay-stream-completion/do",
		"lane-verify-browser-evidence/do",
		"e4b-acceptance-scope/do",
		"lane-plan-boundary/do",
		"hosted-evaluation-coverage/do",
		"integration-rehearsal/do",
		"webui-quality-census/do",
		"webui-silent-failures/do",
		"webui-accessible-names/do",
		"webui-style-consistency/do",
		"webui-media-gallery/do",
		"webui-media-input-slots/do",
		"webui-declared-presets/do",
		"webui-regenerate-from-record/do",
		"webui-artifact-lineage/do",
		"webui-prompt-enhance/do",
