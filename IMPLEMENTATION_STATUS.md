...
| Tensor graph | In progress | Typed IR, layout transforms, head broadcasting, clamp, RMSNorm/affine LayerNorm, token/learned-position embeddings, scaled and YaRN normal/NeoX RoPE, ALiBi, causal and symmetric sliding/softcapped/gated GQA, bidirectional T5 relative-position attention, MLA decomposition, softmax/sigmoid top-k routed gated or ungated SiLU/ReLU/GELU MoE with separate or fused gate/up expert storage, split router inputs, and correction bias, GELU/xIELU/SwiGLU/squared-ReLU, SSM convolution, fused gated delta net, reference/CUDA executors, and arena planner |
...
| Model runtime | In progress | Incremental dense Qwen 2/3, bounded-host/F32-preload/native-quantized Mixtral, Arctic, BailingMoE/BailingMoE2, Cohere2-MoE, DBRX, Deci, DOTS1, DeepSeek v1/DeepSeek2-OCR, ERNIE 4.5-MoE, GraniteMoE, Grok, Hunyuan-Dense/Hunyuan-MoE, HY-V3, Mellum, MiniMax-M2, SmallThinker, Qwen2-MoE, Qwen3-MoE, AFMoE, Laguna MoE, OLMoE, PhiMoE, EXAONE-MoE, and LLaDA-MoE, text-only hybrid Qwen3.5, non-causal no-cache Dream, LLaDA, and RND1 MoE, hybrid LFM2/LFM2-MoE, PLM/MiniCPM3 MLA, BERT/EuroBERT/JinaBERT v2/v3/Llama Embed/NeoBERT/NomicBERT/NomicBERT-MoE encoders, Chameleon decoders with projected soft-token overrides, PaddleOCR text-coordinate decoding, Apertus, Arcee, Baichuan 7B, BitNet, Bloom, CodeShell, dense Cohere2/Command R/ERNIE 4.5, Falcon, Gemma 1/2/3, GLM4, GPT-2/GPT-NeoX, Granite, InternLM2, EXAONE/EXAONE 4, XVERSE, Jais/Jais2, Maincoder, MiniCPM, compatible MPT, dense Mistral 3, Nemotron, OLMo/OLMo2/OLMoE, OpenELM, Orion, Pangu Embedded, Phi-2/Phi-3, PLaMo/PLaMo 3, dense Refact, Seed-OSS, StableLM, StarCoder/StarCoder2, SmolLM3, T5 encoder, and constrained Llama-family CUDA execution with serializable, prefix-editable attention/recurrent cache |
...
ModernBERT runtime integration remains pending. Its symmetric bidirectional
sliding-window blocker is removed: the typed graph, reference executor, and
ABI-v12 CUDA kernel now implement the pinned inclusive half-window mask.
