...
const (
	...
	// LayerOperatorFeedForwardPolicy runs the feed-forward declared by the
	// layer plan: routed expert composition when a router is present,
	// the dense feed-forward runtime otherwise.
