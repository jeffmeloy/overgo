...
func towerProjectorMetadata(
	...
	return []gguf.Metadata{
		...
		gguf.StringMetadata("clip.vision.projector_type", "gemma4vision"),
		gguf.BoolMetadata("clip.has_vision_encoder", true),
		gguf.Uint32Metadata("clip.vision.block_count", vision.HiddenLayers),
		gguf.Uint32Metadata("clip.vision.embedding_length", vision.HiddenSize),
		gguf.Uint32Metadata("clip.vision.feed_forward_length", vision.IntermediateSize),
		gguf.Uint32Metadata("clip.vision.attention.head_count", vision.AttentionHeads),
		gguf.Uint32Metadata("clip.vision.attention.head_count_kv", visionKVHeads),
		gguf.Uint32Metadata("clip.vision.attention.key_length", visionHeadDim),
		gguf.Float32Metadata("clip.vision.attention.layer_norm_epsilon", vision.RMSEpsilon),
		gguf.Uint32Metadata("clip.vision.patch_size", vision.PatchSize),
		gguf.Uint32Metadata("clip.vision.projector_scale_factor", vision.PoolingSize),
		gguf.Uint32Metadata("clip.vision.position_embedding_size", vision.PositionEmbedding),
		gguf.Uint32Metadata("clip.vision.projection_dim", config.Text.HiddenSize),
		gguf.Float32Metadata("clip.vision.rope.freq_base", vision.Rope.Theta),
		...
		gguf.Uint32Metadata("clip.audio.block_count", audio.HiddenLayers),
		gguf.Uint32Metadata("clip.audio.embedding_length", audio.HiddenSize),
		gguf.Uint32Metadata("clip.audio.feed_forward_length", audioFeedForward),
		gguf.Uint32Metadata("clip.audio.attention.head_count", audio.AttentionHeads),
		gguf.Float32Metadata("clip.audio.attention.layer_norm_epsilon", audio.RMSEpsilon),
		gguf.Uint32Metadata("clip.audio.attention.chunk_size", audio.ChunkSize),
		gguf.Uint32Metadata("clip.audio.attention.context_left", audio.ContextLeft),
		gguf.Uint32Metadata("clip.audio.attention.context_right", audio.ContextRight),
		gguf.Float32Metadata("clip.audio.attention.logit_softcapping", audio.LogitCap),
		gguf.Uint32Metadata("clip.audio.conv_kernel_size", audio.ConvKernel),
		gguf.ArrayMetadata("clip.audio.subsampling_conv_channels", gguf.ValueTypeInt32, subChannels),
		gguf.Float32Metadata("clip.audio.residual_weight", audio.ResidualWeight),
		gguf.Uint32Metadata("clip.audio.output_projection_dim", audio.OutputProjDims),
		gguf.Uint32Metadata("clip.audio.projection_dim", config.Text.HiddenSize),
		gguf.StringMetadata("clip.audio.hidden_act", audio.HiddenAct),
		gguf.Uint32Metadata("clip.audio.num_mel_bins", processor.Audio.FeatureSize),
		gguf.Uint32Metadata("clip.audio.fft_length", processor.Audio.FFTLength),
		gguf.Uint32Metadata("clip.audio.frame_length", processor.Audio.FrameLength),
		gguf.Uint32Metadata("clip.audio.hop_length", processor.Audio.HopLength),
		gguf.Uint32Metadata("clip.audio.sample_rate", processor.Audio.SampleRate),
		gguf.Float32Metadata("clip.audio.min_frequency", processor.Audio.MinFrequency),
		gguf.Float32Metadata("clip.audio.max_frequency", processor.Audio.MaxFrequency),
		gguf.Float32Metadata("clip.audio.mel_floor", processor.Audio.MelFloor),
	}
}
