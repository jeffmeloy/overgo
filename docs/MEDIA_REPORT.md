...
| models | local /  | training | true / true / true | 0 / 0 |  No accepted protocol bound to this activation. | `final-model-validation/do` |
| overgo-hfconvert | local /  | inference | true / true / true | 2 / 2 | Four native text cases; 12032 generated MMLU-Pro cases; 541 IFEval prompts and 1668 matched verdicts. No throughput claim. Acceptance retains producer source and protocol scope; current performance and broader quality are not established. | `final-model-validation/do` |
| Qwen2.5-0.5B | local /  | training | true / true / true | 0 / 0 |  No accepted protocol bound to this activation. | `final-model-validation/do` |
| models | local /  | inference | true / true / true | 1 / 1 | Full raw and generated MMLU-Pro; 541 IFEval prompts and 1668 matched verdicts. Numerical and performance findings remain separate. Acceptance retains producer source and protocol scope; current performance and broader quality are not established. | `final-model-validation/do` |
...
| overgo-hfconvert | local /  | training | true / true / true | 0 / 0 |  No accepted protocol bound to this activation. | `final-model-validation/do` |
| overgo-hfconvert | local /  | inference | true / true / true | 2 / 2 | 12032 MMLU-Pro cases and native IFEval: 541 prompts, 834 instructions, 1668 matched verdicts. Instruction-model raw NLL is not a new defect. Acceptance retains producer source and protocol scope; current performance and broader quality are not established. | `final-model-validation/do` |
...
| overgo-hfconvert | local /  | inference | true / true / true | 1 / 1 | 12032 MMLU-Pro cases and native IFEval: 541 prompts, 834 instructions, 1668 matched verdicts. BF16 artifact remains distinct from the native variant. Acceptance retains producer source and protocol scope; current performance and broader quality are not established. | `final-model-validation/do` |
...
| `model:sha256:08d12f90b68fe93f3c39da1bb9f4592a13085c2740716166d2baab708793d3e8` | overgo-hfconvert | true | Registered without task activation or accepted protocol. | `final-model-validation/do` |
...
| `model:sha256:64fb17f3c324dcbf9f83861e5d2ea1534a66ea0970223047e788a482b080853c` | overgo-hfconvert | true | Registered without task activation or accepted protocol. | `final-model-validation/do` |
...
| `model:sha256:764daf929f9d93ae9b2ffe886e6bb5871dd5cb85ebb5e0d94700c2158931e471` | overgo-hfconvert | true | Registered without task activation or accepted protocol. | `final-model-validation/do` |
...
| `model:sha256:cd4ada4703c2b76a84a10da94f09b9199b6d4dad7e3dcabbe79d8cee745f4501` | overgo-hfconvert | true | Registered without task activation or accepted protocol. | `final-model-validation/do` |
...
| `model:sha256:e37577c45aec2255ac437ae6e86518ea99745d6616dd8c59b1fe7e26a04606f7` | overgo-hfconvert | true | Registered without task activation or accepted protocol. | `final-model-validation/do` |
...
| --- | --- | --- | --- |
| `SenseNova-U1-8B-MoT-Infographic-V3/image-gen/1` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `SenseNova-U1-8B-MoT-Infographic-V3/image-gen/2` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `SenseNova-U1-8B-MoT-Infographic-V3/image-gen/3` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `Un-0/image-gen/1` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `Un-0/image-gen/2` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `Un-0/video-gen/1` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `Un-0/video-gen/2` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `SimpleDiffusion-TensorProductAttentionRope/image-gen/1` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `SimpleDiffusion-TensorProductAttentionRope/image-gen/2` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `LiveEdit/video-gen/1` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `LiveEdit/video-gen/2` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `Wan2.1-T2V-1.3B/video-gen/1` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `Wan2.1-T2V-1.3B/video-gen/2` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `Wan2.1-T2V-1.3B/video-gen/3` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
| `Krea-2-Turbo/image-gen/1` | `` | Current source and protocol acceptance are unbound. | `modality-verification/image-and-video` |
