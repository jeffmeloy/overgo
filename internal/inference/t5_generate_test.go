...
func TestGenerateT5Admission(t *testing.T) {
	...
	wrong := &Runner{spec: model.Spec{CommonSpec: model.CommonSpec{Architecture: "llama"}}, vocab: vocab}
	...
	runner := &Runner{spec: model.Spec{CommonSpec: model.CommonSpec{Architecture: "t5"}}, vocab: vocab}
