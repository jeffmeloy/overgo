	...
	return []EntryAuthorityRule{
		...
		},
		{
			...
			Exceptions: map[string]string{
				...
				"internal/processcontrol/resource_release_windows.go": "OS-ABI owner: ntdll and kernel32 list a resource's holders and wait on their handles and its release event",
