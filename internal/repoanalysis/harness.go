...
// AgentHarnessConsolidation summarizes one audit run: source identity, rule
// and declaration counts, and every ownership finding.
...
// Error returns nil for a clean report, otherwise an error naming the finding
// count and the first finding.
