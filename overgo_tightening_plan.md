...
| 6 | Layer execution | architecture-family predicates and duplicate registries absent; alternate-prediction admission and split execution are topology-owned ordered stages; family leaf policies/builders absent; ordered relative encoder/decoder stages plus sealed graph and normalization facts, neutral recurrent, latent, compressed-hyper, WKV, cache, side-input, draft topology/storage, weight catalogs, dense/expert, and rotary IR/selectors | Active |
