...
| 9 | Metadata validation | expert metadata admission is a serialized required/conditional profile fact; family predicates, probes, and validation-enum reconstruction absent | Active |
