...
| 9 | Metadata validation | expert admission and sparse-indexer cadence are serialized profile facts; family predicates, probes, and validation-enum reconstruction absent | Active |
