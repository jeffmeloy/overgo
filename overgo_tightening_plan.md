...
| 6 | Layer execution | family leaf policies/builders absent; validation-free recurrent/dense planning plus neutral encoder, latent, compressed-hyper, WKV, cache, side-input, draft topology/storage, weight catalogs, dense/expert, and rotary IR/selectors | Active |
