...
| Model runtime | In progress | Incremental dense Qwen 2/3, text-only hybrid Qwen3.5, Gemma 1/2/3, Granite, InternLM2, EXAONE, XVERSE, MiniCPM, OLMo2, SmolLM3, T5 encoder, and constrained Llama-family CUDA execution with serializable, prefix-editable attention/recurrent cache |
