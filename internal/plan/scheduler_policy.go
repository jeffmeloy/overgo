...
// SchedulerBudget bounds one selection round in wall-clock and VRAM.
...
func (p SchedulerPolicy) SelectNext(candidates []SchedulerCandidate, budget SchedulerBudget) ([]CandidateRank, error) {
	if budget.WallNS == 0 {
