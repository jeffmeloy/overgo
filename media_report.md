...
Selected tests executed against source base `84c5059b3171302c09ba10b52b04976ed1b9a5dc` and the per-check source changes recorded in the [validation index](docs/image_video_validation.json). This checkpoint does not complete the campaign.
...
Current code generates images with SenseNova, Krea, SimpleDiffusion and Un-0, and video with Wan, LiveEdit and Un-0 through their active recipes. The tests below establish only their stated shapes and comparisons. SenseNova has an unresolved exact-output regression, so current image/video validation is incomplete.

This checkpoint fixes shared GIF timing and the report reader's rejection of valid external JSON-array oracle files. The [cost profile](docs/image_video_costs.json) maps all seven active model/task pairs, common owners, memory lifetimes and CPU/GPU transfers. Its byte estimates are predictions, not measured optimization gains.

Remaining work includes resolving the SenseNova exact-output mismatch, fresh full-length Wan generation and visual/temporal review, complete frozen-case coverage, public workflow and cancellation checks, and matched speed/memory/transfer comparisons. The operator requested a stop after this checkpoint commit; these obligations remain open in the plan.

The GIF checks were repeated after converting the test loop to Go's integer-range syntax. The earlier passing acquisition remains stored as evidence:sha256:436bf59f286ab85b48abb5aa7c3d13b37a6198ab2e6f2e634c17a6fd488e31de; the table cites the final test source.
...
| SenseNova production and full-resolution quality | Not passed: overgo/internal/sensenovarecipe: TestMediaCurrentSenseNovaValidation failed | The 256x256, 2-step production PNG hash check FAILED: expected 6ef4065018d328c2945e6de0a8b87fe3eb2aec44039b43207398969712446de0, observed 03a5a657b1a9c4690dad0673a730a379a4d579a6d46ae8079b5f9218fc3c179c. Separately, the 1536x2720, 50-step quality/performance test passed its unchanged signature bounds: wall 140.804 s and device peak 17.100 GiB. Its PNG differs from the reviewed reference; the whole acquisition remains failed. | `evidence:sha256:974857c7279e1e3e149fd001d546654e7c0e5278ff97f88891ee07ce0eb76ade` |
| SenseNova native diagnostic | Not passed: overgo/internal/sensenovarecipe: TestMediaSenseNovaDiagnosis failed | Native source/input identity and all sampled latent, layer, boundary and velocity comparisons passed their existing bounds. The final PNG hash check still FAILED: expected bc7dabb6526beee13200a1b421e080c5015354bfee66fba75d4dbf1dc44c8617, observed 1b63ee276369cf58735ac90ccaf3656faf5696214380bf16a3526cbac20d8640. The cause remains unresolved; neither exact reference was changed. | `evidence:sha256:a0d1acb69623ea35be8bde2ce15f11cda2f9962c1bf4d62b419e9a90628cc8f4` |
...
The samples below come from earlier stored runs. Their original source and environment fields remain unchanged. Historical GIFs retain their original timing; they have not been regenerated by this checkpoint.
