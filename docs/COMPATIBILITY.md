...
| `multimodal-token-counting` | implemented | Chat and Responses token counts use the projected media prompt. | [`func (h *Handler) responsesInputTokens(`](../internal/server/server.go)<br>[`func TestMultimodalInputTokenCounting(`](../internal/server/server_part2_test.go) |
