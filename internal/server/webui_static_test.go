...
func TestWebUIServesEmbeddedAssets(t *testing.T) {
	...
	cases := []struct {
		...
		{"/mod/video.js", "text/javascript; charset=utf-8", `generationTab("video-gen"`},
		{"/mod/generation.js", "text/javascript; charset=utf-8", `scope: "generation"`},
		{"/mod/image.js", "text/javascript; charset=utf-8", `generationTab("image-gen"`},
		{"/mod/speech.js", "text/javascript; charset=utf-8", `generationTab("speech"`},
