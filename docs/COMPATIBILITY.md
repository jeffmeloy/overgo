...
| `editable-prompt-cache` | implemented | Bounded prompt caches support selection, eviction, and context edits. | [`func (r *Runner) selectPromptCache(`](../internal/inference/prompt_cache.go)<br>[`func TestMultiplePromptCacheSelectionAndEviction(`](../internal/inference/prompt_cache_test.go) |
| `multimodal-token-counting` | implemented | Chat and Responses token counts use the projected media prompt. | [`func (h *Handler) responsesInputTokens(`](../internal/server/server.go)<br>[`func TestMultimodalInputTokenCounting(`](../internal/server/server_test.go) |
| `ordered-multi-image` | implemented | Native, Chat, and Responses prompts preserve ordered image/text parts. | [`func (r *Qwen3VLRunner) BuildImagesPrompt(`](../internal/projector/prompt.go)<br>[`func TestResponsesMultipleImagesPreservesContentOrder(`](../internal/server/server_test.go) |
