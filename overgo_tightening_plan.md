...
| 6 | Layer execution | family leaf policies/builders absent; encoder, recurrent, latent, cache, side-input, draft topology/storage, dense/expert, and rotary selectors neutralized | Active |
