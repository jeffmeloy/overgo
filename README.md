...
ERNIE 4.5/ERNIE 4.5-MoE, BERT/EuroBERT/JinaBERT v2/v3/Llama Embed/NeoBERT/NomicBERT/NomicBERT-MoE encoders, GLM4, GPT-2/GPT-NeoX, Granite/GraniteMoE, Grok, Hunyuan-Dense/Hunyuan-MoE, HY-V3 decoder trunks, Chameleon decoders with projected soft-token input,
