...
func towerProjectorMetadata(
	...
	return []gguf.Metadata{
		...
		arrayMetadata("clip.vision.image_mean", gguf.ValueTypeFloat32, processor.Image.Mean),
		arrayMetadata("clip.vision.image_std", gguf.ValueTypeFloat32, processor.Image.Std),
