...
- Gemma 4 unified image projection executes the encoder-free `gemma4uv` GGUF
  ...
  projector metadata. Gemma audio/video projection and projector CUDA offload
  remain pending.
