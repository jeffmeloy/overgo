...
| 8 | Runtime admission | continuous batching, retained-cache, capture, sequence-cache, projected-input, and specialized-output admission compiled; remaining architecture probes/fallbacks absent | Active |
