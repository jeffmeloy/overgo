...
normalized softmax top-k routing through bounded-host and F32-preload CUDA
paths. Metadata, strict catalog, graph semantics, and complete reference/CUDA
block differential tests pass. Native quantized expert kernels and real-model
validation remain pending because no Mixtral GGUF is available locally.
